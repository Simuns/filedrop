...
static void rtl8125a_config_eee_phy(struct rtl8169_private *tp)
{
	struct phy_device *phydev = tp->phydev;
...
static void rtl8169_hw_reset(struct rtl8169_private *tp)
{
	...
	case RTL_GIGA_MAC_VER_63:
		RTL_W8(tp, ChipCmd, RTL_R8(tp, ChipCmd) | StopReq);
		rtl_udelay_loop_wait_high(tp, &rtl_rxtx_empty_cond, 100, 42);
		rtl_udelay_loop_wait_high(tp, &rtl_rxtx_empty_cond_2, 100, 42);
		break;
	default:
		RTL_W8(tp, ChipCmd, RTL_R8(tp, ChipCmd) | StopReq);
		udelay(100);
